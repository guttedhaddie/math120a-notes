...
% 		\end{enumerate}
		...
		\item\label{exs:centerquotientcyclic} (Hard, but fun) \ Prove that if $\quotient G{Z(G)}$ is cyclic, then $G$ is abelian. What is the group $\quotient G{Z(G)}$ in such a situation?
