...
The proof might be a notational horror, but it simply amounts to the example done abstractly!
...
\begin{examples}{}{conjexample}
   ...
   \]
	...
	\[
		...
		=(1\,6\,5)(3\,4\,7) =\tau
	\]
	Other choices of $\rho$ are available: just write the orbits of $\sigma,\tau$ in different orders.
	\begin{enumerate}\setcounter{enumi}{1}
