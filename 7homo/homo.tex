...
Other homomorphisms are possible in all the above examples. This approach requires a little creativity! In general, it can be very difficult to \emph{construct} a simple homomorphism with the correct kernel. %The primary application of the theorem comes when starting with a given homomorphism.
