...
label(Label(rotate(aCos(1/3)-90,vert[1],vert[2])*rotate(60,Z)*YZ()*"\Huge 3"),(vert[0]+vert[1]+vert[2])/2.9,Embedded);
label(Label(rotate(aCos(1/3)-90,vert[2],vert[3])*rotate(180,Z)*YZ()*"\Huge 1"),(vert[0]+vert[3]+vert[2])/2.9,Embedded);
label(Label(rotate(aCos(1/3)-90,vert[3],vert[1])*rotate(300,Z)*YZ()*"\Huge 2"),(vert[0]+vert[1]+vert[3])/2.9,Embedded);
