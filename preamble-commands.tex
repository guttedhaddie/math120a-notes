...
\def\opast{\mathbin{\ast}}
\def\opstar{\mathbin{\star}}
...
%\def\quotient#1#2{\scalebox{0.8}{${}^{\textstyle {#1}}\!\big/_{\textstyle \!{#2}}$}}
\def\quotient#1#2{\scalebox{0.95}{\raisebox{2.5pt}{$#1$}\!\big/\!\raisebox{-3.5pt}{$#2$}}}
