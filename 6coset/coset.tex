...
\begin{examples}{}{normalmoreex}
	...
	\begin{enumerate}\setcounter{enumi}{1}
	  \item $\ip{2\pi}=2\pi\Z=\{2\pi n:n\in\Z\}$ is a subgroup of the abelian group $(\R,+)$. In any given coset, there is a unique real number $x$ such that $0\le x<2\pi$ (think `take the remainder modulo $2\pi$'). It follows that
	  \[
